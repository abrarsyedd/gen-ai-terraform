...
module "keypair_5e66c4" {
  source                  = "./modules/keypair_5e66c4"
  project_name            = "GenAI"
  environment             = "dev"
  name                    = "GenAI-keypair-5e66c4"
}

module "ec2_instance_5e66c4" {
  source                  = "./modules/ec2_5e66c4"
  project_name            = "GenAI"
  environment             = "dev"
  name                    = "GenAI-ec2-5e66c4"
  ...
  user_security_groups    = []
  encrypted               = false
  key_name                = module.keypair_5e66c4.key_name
  user_data = <<-EOF
  #!/bin/bash
  yum update -y
  yum install -y httpd
...
output "ec2_instance_id_5e66c4" { value = module.ec2_instance_5e66c4.instance_id }
output "ec2_public_ip_5e66c4"    { value = module.ec2_instance_5e66c4.public_ip }
output "ec2_private_ip_5e66c4"   { value = module.ec2_instance_5e66c4.private_ip }
