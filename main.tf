...
module "keypair_528a31" {
  source                  = "./modules/keypair_528a31"
  project_name            = "GenAI"
  environment             = "dev"
  name                    = "GenAI-keypair-528a31"
}

module "ec2_instance_528a31" {
  source                  = "./modules/ec2_528a31"
  project_name            = "GenAI"
  environment             = "dev"
  name                    = "GenAI-ec2-528a31"
  instance_type           = "t3.micro"
  subnet_id               = ""
  vpc_subnets             = []
  vpc_security_group_ids  = []
  user_security_groups    = []
  encrypted               = false
  key_name                = module.keypair_528a31.key_name
  user_data = <<-EOF
  #!/bin/bash
  yum update -y
  yum install -y httpd
...
output "ec2_instance_id_528a31" { value = module.ec2_instance_528a31.instance_id }
output "ec2_public_ip_528a31"    { value = module.ec2_instance_528a31.public_ip }
output "ec2_private_ip_528a31"   { value = module.ec2_instance_528a31.private_ip }
